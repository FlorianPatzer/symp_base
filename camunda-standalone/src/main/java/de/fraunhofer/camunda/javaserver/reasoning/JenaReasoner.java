...
@Getter
@Setter
public class JenaReasoner implements FraunhoferReasoner<String, String> {
    ...
    public JenaReasoner(InputStream in, File out) throws FileNotFoundException {
