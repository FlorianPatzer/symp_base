...
public class MergeOntologyTest {
    ...
    @Before
    public void setup() {
        paths = new ArrayList<String>(Arrays.asList("/home/ubuntu/Documents/camunda-platform-java/src/test/resources/testExpansion/a.txt", "/home/ubuntu/Documents/camunda-platform-java/src/test/resources/testExpansion/b.txt"));
    }
