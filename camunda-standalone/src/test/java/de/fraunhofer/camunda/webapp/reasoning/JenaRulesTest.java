...
import de.fraunhofer.camunda.javaserver.reasoning.JenaReasoner;
...
public class JenaRulesTest extends OWLTest {
    ...
    public void test() throws IOException {
        ...
        synchronized (JenaRulesTest.ONTOLOGY_FILE) {
            JenaReasoner nrb = new JenaReasoner(new FileInputStream(JenaRulesTest.ONTOLOGY_FILE), JenaRulesTest.ONTOLOGY_FILE);
            nrb.addRules(rules);
            nrb.infer();
            nrb.saveOntology();
    ...
    public void testAddJohnSmith() throws FileNotFoundException {
        ...
        JenaReasoner jena = new JenaReasoner(is, new File("src/test/resources", "testAddJohnSmith2.owl"));
