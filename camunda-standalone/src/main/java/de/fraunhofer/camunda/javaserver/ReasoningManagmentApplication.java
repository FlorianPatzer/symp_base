...
import de.fraunhofer.camunda.javaserver.external.reasoning.ExternalReasoningWorker;
...
public class ReasoningManagmentApplication extends ServletProcessApplication {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        log.info("--------------------------------");
        ExternalWorker.setDefaultDir(new File(basePath, "webapps/reasoning_bpm_war_exploded/out"));
    ...
    private void startExternalWorkers() {
        ...
        File outPath = new File(basePath, "webapps/reasoning_bpm_war_exploded/out");
